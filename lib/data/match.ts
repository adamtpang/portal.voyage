// Portal matching engine. Given a user's passport, archetype, sector, and
...
import type { City, Sector } from "@/lib/data/cities";
...
export function scoreCity(c: City, input: PortalInput): CityResult {
